...
public class DoublyLinkedListLibraryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        // Adding books
        library.addAtBeginning("Book1", "ABC", "Genre1", 101, true);
        library.addAtEnd("Book2", "XYZ", "Genre2", 102, true);
        library.addAt(2, "Book3", "PQR", "Genre3", 103, true);
